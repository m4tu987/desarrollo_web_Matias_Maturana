...
const temas = ["Música","Deporte","Ciencias","Religion","Politica","Tecnologia","Juegos","Baile","Comida","Otro"]
...
function mostrarInput(){
    var select = document.getElementById("select-contactar"); //Contactar
    var input = document.getElementById("input-otra");
    var select2 = document.getElementById("select-temas"); // Temas
    var input2 = document.getElementById("input-otro-tema");
    if (select.value == "otro"){
        input.style.display = "block";
        input.placeholder = "Escribe tu contacto";
    } else {
        input.style.display = "none";
    }
    if (select2.value == "otro"){
        input2.style.display = "block";
        input2.placeholder = "Escribe un tema";
    } else{
